ActiveAdmin.register Booking do
  form do |f|
    f.inputs do
      ...
      f.input :referal_enterprise # rename to job_description
    ...
    f.inputs "Requirement" do
      ...
      f.input :duration #auto calculate
    ...
    f.inputs "Total Revenue" do
      f.input :on_ride_duration #ride_end - ride_start
      f.input :on_ride_amount # on_ride_duration * 100 (8am to 6pm min 3hr 300 addional 100/hr) 6pm to 8am min 3hr 400 additional 100/hr
      f.input :pre_ride_duration
      f.input :pre_ride_duration_amount # 100/hr
      ...
      f.input :toll_parking_charges # rename label toll/parking
      f.input :other_charges
      f.input :tip_charges
      f.input :total_waiver #(label clap + driver)
      f.input :clap_waiver
    ...
    f.inputs "Payments" do
      ...
      f.input :collected_from_customer # rename to amount collecteted from customer
      f.input :expense # pre_ride_duration_amount + post_ride_duration_amount + food_charges + accomodation_charges + toll_parking_charges + total_waiver + clap_waiver
      f.input :driver_expense # execpt clap waiver
      f.input :after_expense_trip  # net_billing - expense
      f.input :clap_expenses # clap_waiver
      ...
      f.input :collection_status, collection: ["Pending", "Partially Collected", "Collected"] # rename label to settlement status
    end
